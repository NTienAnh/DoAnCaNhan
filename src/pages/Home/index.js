          ...
          <div className="widget-ticker">
            <div className="widget-left">
              <div className="widget-chart">
                <Link to="/">
                  <img style={{ width: "100%", height: "29px" }} className='avatar' src='https://static-znews.zadn.vn/images/stat.svg' />
                </Link>
              </div>
              <div className="tag">
            ...
            <div className='widget-right'>
              ...
              <img style={{ width: "auto", height: "30px" }} className='avatar' src='https://static-znews.zingcdn.me/images/icons/weather/v2/hazy.png' />
            </div>
            ...
            <div className='content-left'>
              ...
              {data1.map((item, index) => (
                <div className="item-left" key={index}>
                  <img style={{ width: "120px", height: "80px" }} className='img-left' src={item.image} alt="/" />
                  <Link to="/details">
                    <h4 className='title-left' style={{fontFamily:"Arial, sans-serif",fontWeight:"bold"}}>{item.title}</h4>
                  </Link>
                </div>
              ))}
            </div>
            ...
            <div className='content-mid mid-mid'>
              ...
              {data2.map((item, index) => (
                <div className="item-mid" key={index}>
                  <img style={{ width: "100%", height: "328px" }} src={item.image} alt="" />
                  <h2 style={{ marginTop: "10px" }}>{item.title}</h2>
                  <p>{item.description}</p>
                  <h3 className='title-mid' style={{ fontWeight: "bold", fontSize: "14px",fontFamily:"Arial, sans-serif" }}>{item.content}</h3>
                </div>
              ))}
            </div>
            <div className='content-right right-right'>
              ...
              {data3.map((item, index) => (
                <div className="item-right" key={index}>
                  <img style={{ width: "258px", height: "172px" }} src={item.image} alt="/" />
                  <Link to="/titleId">
                    <h4 className='title-right' style={{marginTop:"10px",fontFamily:"Arial, sans-serif"}}>{item.title}</h4>
                  </Link>
                </div>
              ))}
            </div>
